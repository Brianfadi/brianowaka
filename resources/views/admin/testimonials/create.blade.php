...
@section('page-subtitle', 'Create a new customer testimonial')
            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <textarea name="content" rows="5" required
                              ...
                              class="w-full px-4 py-2.5 bg-gray-800 border border-gray-700 rounded-lg text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent">{{ old('content') }}</textarea>
                    @error('content')
                        <p class="mt-1 text-sm text-red-400">{{ $message }}</p>
                    @enderror
                </div>
                ...
                {{-- Avatar --}}
                <div>
                    <label class="block text-sm font-medium text-gray-300 mb-2">Avatar Image (Optional)</label>
