...
@section('page-title', 'Add Pricing Tier')
@section('page-subtitle', 'Create a new pricing tier for the Investment section')
...
<form action="{{ route('admin.pricing-tiers.store') }}" method="POST">
@csrf
            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <textarea name="description" rows="3" required class="form-input"
                              placeholder="Brief description of what's included in this tier...">{{ old('description') }}</textarea>
