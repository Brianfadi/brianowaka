        ...
        <div class="bg-gray-900 border border-gray-800 rounded-xl p-5">
            ...
            <div class="mb-4">
                ...
                <div class="grid grid-cols-3 sm:grid-cols-4 gap-2">
                    ...
                    <div class="aspect-video bg-gray-800 rounded-lg overflow-hidden border border-gray-700">
            ...
            {{-- File Upload Section --}}
            <div class="mb-4">
                <label class="form-label">Upload New Images from Computer</label>
            ...
            <div>
                ...
                <textarea name="images" id="image_urls" rows="4" class="form-input font-mono text-xs">{{ old('images', is_array($project->images) ? implode("\n", $project->images) : '') }}</textarea>
                <p class="text-xs text-gray-600 mt-1">Leave empty to keep current images. New uploads will be added to existing images.</p>
            </div>
        </div>
        ...
        reader.onload = function(e) {
            ...
            previewDiv.innerHTML = `
                <div class="relative aspect-video bg-gray-800 rounded-lg overflow-hidden border border-gray-700">
                    <img src="${e.target.result}" class="w-full h-full object-cover" alt="Preview ${index + 1}" loading="lazy">
