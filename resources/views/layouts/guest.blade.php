...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans antialiased">
        <!-- Topbar -->
        <div class="fixed top-0 left-0 right-0 z-[60] bg-gradient-to-r from-purple-900 via-pink-900 to-purple-950 text-gray-200 text-xs sm:text-sm">
        ...
        <div class="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-600 via-purple-600 to-blue-800 relative overflow-hidden">
            ...
            <!-- Navigation -->
            <nav class="absolute top-0 left-0 right-0 z-10" style="margin-top: 36px;">
                <div class="w-full px-4 sm:px-6 lg:px-8">
